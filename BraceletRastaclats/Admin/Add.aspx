<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="BraceletRastaclats.Admin.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:IdentityConnectionString %>" DeleteCommand="DELETE FROM [Product] WHERE [ProductID] = @original_ProductID AND (([Productdescription] = @original_Productdescription) OR ([Productdescription] IS NULL AND @original_Productdescription IS NULL)) AND (([Productname] = @original_Productname) OR ([Productname] IS NULL AND @original_Productname IS NULL)) AND (([Producttype] = @original_Producttype) OR ([Producttype] IS NULL AND @original_Producttype IS NULL)) AND (([Productprice] = @original_Productprice) OR ([Productprice] IS NULL AND @original_Productprice IS NULL)) AND (([Productquantity] = @original_Productquantity) OR ([Productquantity] IS NULL AND @original_Productquantity IS NULL))" InsertCommand="INSERT INTO [Product] ([ProductID], [Productdescription], [Productname], [Producttype], [Productprice], [Productquantity]) VALUES (@ProductID, @Productdescription, @Productname, @Producttype, @Productprice, @Productquantity)" SelectCommand="SELECT * FROM [Product]" UpdateCommand="UPDATE [Product] SET [Productdescription] = @Productdescription, [Productname] = @Productname, [Producttype] = @Producttype, [Productprice] = @Productprice, [Productquantity] = @Productquantity WHERE [ProductID] = @original_ProductID AND (([Productdescription] = @original_Productdescription) OR ([Productdescription] IS NULL AND @original_Productdescription IS NULL)) AND (([Productname] = @original_Productname) OR ([Productname] IS NULL AND @original_Productname IS NULL)) AND (([Producttype] = @original_Producttype) OR ([Producttype] IS NULL AND @original_Producttype IS NULL)) AND (([Productprice] = @original_Productprice) OR ([Productprice] IS NULL AND @original_Productprice IS NULL)) AND (([Productquantity] = @original_Productquantity) OR ([Productquantity] IS NULL AND @original_Productquantity IS NULL))" ConflictDetection="CompareAllValues" OldValuesParameterFormatString="original_{0}">
            <DeleteParameters>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="margin-bottom: 0px" Text="Back" />
    </form>
</asp:Content>
